...
('339', 'Jiao, Yuling', ''),
('340', 'Steger, C.', ''),
('341', 'Gyori, Benjamin M', ''),
('342', 'Venkatachalam, Gireedhar', ''),
('343', 'Thiagarajan, P S', ''),
('344', 'Hsu, David', ''),
('345', 'Clement, Marie-Veronique', ''),
('346', 'Munjal, Akankshi', ''),
('347', 'Philippe, Jean-Marc', ''),
('348', 'Munro, Edwin', ''),
('349', 'Lecuit, Thomas', ''),
('350', 'Sacan, A.', ''),
('351', 'Ferhatosmanoglu, H.', ''),
('352', 'Coskun, H.', ''),
('353', 'Feillet, C.', ''),
('354', 'Krusche, P.', ''),
('355', 'Tamanini, F.', ''),
...
('361', 'Levi, F. A.', ''),
('362', 'Bretschneider, T.', ''),
('363', 'van der Horst, G. T. J.', ''),
('364', 'Delaunay, F.', ''),
('365', 'Rand, D. A.', ''),
('366', 'Downey, Mike J.', ''),
('367', 'Jeziorska, Danuta M.', ''),
('368', 'Ott, Sascha', ''),
('369', 'Tamai, T. Katherine', ''),
('370', 'Koentges, Georgy', ''),
('371', 'Vance, Keith W.', ''),
('372', 'Bretschneider, Till', ''),
('373', 'Cimini, Daniela', ''),
('374', 'Boudaoud, Arezki', ''),
('375', 'Burian, Agata', ''),
('376', 'Borowska-Wykr?t, Dorota', ''),
('377', 'Uyttewaal, Magalie', ''),
('378', 'Wrzalik, Roman', ''),
('379', 'Kwiatkowska, Dorota', ''),
('380', 'Hamant, Olivier', ''),
('381', 'Andrey, Philippe', ''),
('382', 'Kiêu, Kiên', ''),
('383', 'Kress, Clémence', ''),
...
('386', 'Liu, Zichuan', ''),
('387', 'Biot, Eric', ''),
('388', 'Adenot, Pierre-Gaël', ''),
('389', 'Hue-Beauvais, Cathy', ''),
('390', 'Houba-Hérin, Nicole', ''),
('391', 'Duranthon, Véronique', ''),
('392', 'Devinoy, Eve', ''),
('393', 'Beaujean, Nathalie', ''),
('394', 'Gaudin, Valérie', ''),
('395', 'Maurin, Yves', ''),
('396', 'Debey, Pascale', ''),
('397', 'Arganda-Carreras, Ignacio', ''),
('398', 'Fernández-González, Rodrigo', ''),
('399', 'Muñoz-Barrutia, Arrate', ''),
('400', 'Ortiz-De-Solorzano, Carlos', ''),
('401', 'Nieuwenhuizen, Robert P J', ''),
('402', 'Lidke, Keith A', ''),
('403', 'Bates, Mark', ''),
('404', 'Puig, Daniela Leyton', ''),
('405', 'Grünwald, David', ''),
('406', 'Stallinga, Sjoerd', ''),
('407', 'Rieger, Bernd', ''),
('408', 'van Heel, Marin', ''),
('409', 'Schatz, Michael', ''),
('410', 'Legland, David', ''),
...
('418', 'Anne Beghin', ''),
('419', 'Daniel Choquet', ''),
('420', 'Jean-Baptiste Sibarita', ''),
('421', 'Müller, Marcel', ''),
('422', 'Mönkemöller, Viola', ''),
('423', 'Hennig, Simon', ''),
('424', 'Hübner, Wolfgang', ''),
('425', 'Huser, Thomas', ''),
('426', 'K?ížek, Pavel', ''),
...
('430', 'Hagen, Guy M', ''),
('431', 'Yaser Afshar', ''),
('432', 'Ivo F. Sbalzarini1', ''),
('433', 'Pageon, Sophie V', ''),
('434', 'Nicovich, Philip R', ''),
('435', 'Mollazade, Mahdie', ''),
('436', 'Tabarin, Thibault', ''),
('437', 'Gaus, Katharina', ''),
('438', 'Kechkar, Adel', ''),
('439', 'Nair, Deepak', ''),
('440', 'Heilemann, Mike', ''),
('441', 'Choquet, Daniel', ''),
('442', 'Sibarita, Jean-Baptiste', ''),
('443', 'Chao, Jerry', ''),
('444', 'Ward, E Sally', ''),
('445', 'Ober, Raimund J', ''),
('446', 'Mazouchi, A', ''),
...
('448', 'Bolte, S', ''),
('449', 'Cordelières, F P', ''),
('450', 'de Moraes, Luciana Vieira', ''),
('451', 'Tadokoro, Carlos Eduardo', ''),
('452', 'Gómez-Conde, Iván', ''),
('453', 'Olivieri, David N', ''),
('454', 'Penha-Gonçalves, Carlos', ''),
('455', 'Danielson, Eric', ''),
('456', 'Lee, Sang H', ''),
('457', 'Tang, Yunqing', ''),
('458', 'Hendriks, Johnny', ''),
...
('484', 'Henrik Skibbe', ''),
('485', 'Benjamin Drayer', ''),
('486', 'Thorsten Schmidt', ''),
('487', 'Alida Filippi', ''),
('488', 'Roland Nitschke', ''),
('489', 'Thomas Brox', ''),
('490', 'Hans Burkhardt', ''),
('491', 'Wolfgang Driever', ''),
('492', 'Culley, Siân', ''),
('493', 'Towers, Greg J', ''),
('494', 'Selwood, David L', ''),
('495', 'Henriques, Ricardo', ''),
('496', 'Grove, Joe', ''),
('497', 'Olsson, Tjelvar S. G.', ''),
('498', 'Hartley, Matthew', '');

-- --------------------------------------------------------

--
-- Structure de la table `bibliotype`
--
...
INSERT INTO `bibliotype` (`id_type`, `Name`) VALUES
('100', 'Book'),
('101', 'Book Chapter'),
('102', 'Journal Article'),
...
CREATE TABLE `entity` (
  ...
  `id_user_skill` decimal(10,0) DEFAULT NULL,
  `id_curator` decimal(10,0) NOT NULL DEFAULT '0',
  `id_paper` decimal(10,0) DEFAULT NULL,
  `Title` varchar(255) DEFAULT NULL,
  `Body` longtext,
...
('3', '3', '2', NULL, 'DIPimage', 'DIPimage is a MATLAB toolbox for scientific image processing and analysis build on the DIPlib image library. It is a tool for teaching and research in image processing. Most operations are independent of dimensionality, and are defined for any data type that MATLAB can store. Many functions are available through a GUI, which makes them more accessible to novices. The interactive image display windows, to which images can be automatically displayed after each operation, provide great insight into the image data.<br />DIPlib is a platform independent scientific image processing library written in C. It consists of a large number of functions for processing and analysing multi-dimensional image data. The library provides functions for performing transforms, filter operations, object generation, local structure analysis, object measurements and statistical analysis of images. Key design features include ample support for different data types (binary, integer, floating point, complex) and dimensionalities.', NULL, NULL, NULL, NULL),
('1513', NULL, '0', NULL, 'Difference of Gaussians', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1544', NULL, '0', NULL, 'Xuggler Slider', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Xuggler Slider', NULL),
('1604', NULL, '0', NULL, 'Volocity Acquisition', NULL, NULL, NULL, 'http://www.perkinelmer.com/pages/020/cellularimaging/products/volocityacquisition.xhtml', NULL),
('1775', NULL, '0', NULL, 'PhagoTracker', NULL, NULL, NULL, 'http://www.weizmann.ac.il/vet/IC/software/wis-phagotracker', NULL),
('1779', NULL, '0', NULL, 'DensitoQuant', NULL, NULL, NULL, 'http://www.3dhistech.com/DensitoQuant_module', NULL),
('1780', NULL, '0', NULL, 'NuclearQuant', NULL, NULL, NULL, 'http://www.3dhistech.com/nuclearquant_module', NULL),
('1790', NULL, '0', NULL, 'Panoramic Viewer', NULL, NULL, NULL, 'http://www.3dhistech.com/pannoramic_viewer', NULL),
('1791', NULL, '0', NULL, 'NeuroMath', NULL, NULL, NULL, 'http://www.weizmann.ac.il/vet/IC/software/wis-neuromath', NULL),
('1800', NULL, '0', NULL, 'HistoQuant', NULL, NULL, NULL, 'http://www.3dhistech.com/HistoQuant_module', NULL),
('1802', NULL, '0', NULL, 'MembraneQuant', NULL, NULL, NULL, 'http://www.3dhistech.com/membranequant_module', NULL),
('1916', NULL, '0', NULL, 'Volocity Restoration', NULL, NULL, NULL, 'http://www.perkinelmer.com/pages/020/cellularimaging/products/volocityrestoration.xhtml', NULL),
('2110', NULL, '4', NULL, 'Introduction to DIPimage', 'The goal of this laboratory work is to get hands-on experience with image processing. To do so, you will have to learn the image-processing environment: MATLAB and the DIPimage toolbox for multi-dimensional image processing. To facilitate a quick start, there will not be an in-depth explanation of all the features in the software. We will briefly present the things you need at this moment. We have marked the sections that explain something about the environment with the?symbol, so that they stand out. Let us start with a short introduction to the MATLAB environment.', NULL, NULL, 'ftp://qiftp.tudelft.nl/DIPimage/docs/Introduction_to_DIPimage.pdf', NULL),
('2112', NULL, '4', NULL, 'Image Analysis', 'The goal of this laboratory course is to get hands-on experience with image processing. To do so, you will have to learn the image-processing environment: MATLAB and the DIPimage toolbox for scientific image processing. To facilitate a quick start, there will not be an in-depth explanation of all the features in the software. We will briefly present the things you need at this moment. We have marked the sections that explain something about the environment with the ? symbol, so that they stand out.\r\nFirst we want to stress one point: Try to understand what is happening, and do not be satisfied with just any answer you obtain! It is by far better that you seriously wor on half of the exercises and learn some image processing, than that you go through all of them, but understand nothing. This is a waste of your time.', NULL, NULL, 'http://www.cb.uu.se/%7Ecris/Documents/ipcourse.pdf', NULL),
('2103', NULL, '79', NULL, 'Image Analysis for Biology', 'Thourough introduction to image analysis using matlab\r\nCaltech, MBL Physiology Course 2008', NULL, NULL, 'http://www.rpgroup.caltech.edu/courses/PBoC%20ASTAR/files_2011/Matlab/Image%20Analysis%20with%20Matlab.pdf', NULL),
('767', NULL, '16', NULL, 'Java', 'TEST', NULL, NULL, 'http://www.oracle.com/technetwork/java/index.html', NULL),
('2113', NULL, '0', NULL, 'C++', NULL, NULL, NULL, 'http://www.stroustrup.com/C++.html', NULL),
('2114', NULL, '0', NULL, 'ImageJ Macro Language', NULL, NULL, NULL, 'http://imagej.net/developer/macro/macros.html', NULL),
('2122', NULL, '0', NULL, 'Jython', 'Jython is an implementation of the Python programming language written in Java.\r\nJython is supported by the\r\nFIJI scripting editor and can thus be used to write ImageJ Macros (see http://fiji.sc/wiki/index.php/Jython_Scripting).', NULL, NULL, 'http://www.jython.org/', NULL),
('2108', NULL, '0', NULL, 'R', NULL, NULL, NULL, 'http://cran.r-project.org/', NULL),
('623', NULL, '16', NULL, 'Python', 'The Python programming language', NULL, NULL, 'http://www.python.org/', NULL),
('1447', NULL, '0', NULL, 'Annotation', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Annotation', NULL),
('1453', NULL, '0', NULL, 'ApplyThreshold', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/ApplyThreshold.html', NULL),
('1477', NULL, '0', NULL, 'Adaptive Thresholding', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1577', NULL, '0', NULL, 'Auto Threshold', NULL, NULL, NULL, 'http://fiji.sc/Auto_Threshold', NULL),
('1588', NULL, '0', NULL, 'Active Cells SDK', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Active_Cells_SDK', NULL),
('1611', NULL, '0', NULL, 'Align RGB planes', NULL, NULL, NULL, 'http://fiji.sc/Align_RGB_planes', NULL),
('1613', NULL, '0', NULL, 'Anisotropic Diffusion 2D', NULL, NULL, NULL, 'http://fiji.sc/Anisotropic_Diffusion_2D', NULL),
('1623', NULL, '0', NULL, 'Average Filter', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1628', NULL, '0', NULL, 'Auto Crop', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1631', NULL, '0', NULL, 'Align Image', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1641', NULL, '0', NULL, 'Anisotropic Diffusion', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1660', NULL, '0', NULL, 'Align Image by line ROI', NULL, NULL, NULL, 'http://fiji.sc/Align_Image_by_line_ROI', NULL),
('1662', NULL, '0', NULL, 'Active Cells Tracker', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Active_Cells_Tracker', NULL),
('1667', NULL, '0', NULL, 'Affine transformation software', NULL, NULL, NULL, 'http://bigwww.epfl.ch/thevenaz/affine/', NULL),
('1670', NULL, '0', NULL, 'Angle Helper', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Angle_Helper', NULL),
('1676', NULL, '0', NULL, 'Animation 3D', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Animation_3D', NULL),
('1700', NULL, '0', NULL, 'Animated overlay tutorial', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Animated overlay tutorial', NULL),
('1737', NULL, '0', NULL, 'Autocomplete', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Autocomplete', NULL),
('1753', NULL, '0', NULL, 'Auto Crop', NULL, NULL, NULL, 'http://fiji.sc/Auto_Crop', NULL),
('1756', NULL, '0', NULL, '3View import list', NULL, NULL, NULL, 'http://fiji.sc/3View_import_list', NULL),
('1757', NULL, '0', NULL, 'Anaglyph for Red Cyan glasses', NULL, NULL, NULL, 'http://fiji.sc/Anaglyph_for_Red_Cyan_glasses', NULL),
('1759', NULL, '0', NULL, '3D Rotation', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/3D_Rotation', NULL),
('1763', NULL, '0', NULL, 'BEEPS', NULL, NULL, NULL, 'http://bigwww.epfl.ch/thevenaz/beeps', NULL),
('1765', NULL, '0', NULL, '3D Surface Plot', NULL, NULL, NULL, 'http://rsb.info.nih.gov/ij/plugins/surface-plot-3d.html', NULL),
('1767', NULL, '0', NULL, 'Arrow', NULL, NULL, NULL, 'http://fiji.sc/Arrow', NULL),
('1789', NULL, '0', NULL, 'Analyze', NULL, NULL, NULL, 'http://www.analyzedirect.com/', NULL),
('1920', NULL, '0', NULL, 'Active Cells', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Active_Cells', NULL),
('2055', NULL, '0', NULL, 'Anisotropic Filter', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Anisotropic_Filter', NULL),
('2065', NULL, '0', NULL, '3D ROI stacks', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/3D_ROI_stacks', NULL),
('2082', NULL, '0', NULL, 'Adaptive histogram equalization', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Adaptive_histogram_equalization', NULL),
('2127', NULL, '0', NULL, 'Align', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/Align.html', NULL),
('1459', NULL, '0', NULL, 'Chess', NULL, NULL, NULL, 'http://fiji.sc/Chess', NULL),
('1467', NULL, '0', NULL, 'Colour Deconvolution', NULL, NULL, NULL, 'http://fiji.sc/Colour_Deconvolution', NULL),
('1479', NULL, '0', NULL, 'Chronometer', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Chronometer', NULL),
('1499', NULL, '0', NULL, 'Blend two images', NULL, NULL, NULL, 'http://fiji.sc/Blend_two_images', NULL),
('1501', NULL, '0', NULL, 'Chart tutorial 2', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Chart tutorial 2', NULL),
('1526', NULL, '0', NULL, 'Chart tutorial 1', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Chart tutorial 1', NULL),
('1574', NULL, '0', NULL, 'Best Threshold', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Best_Threshold', NULL),
('1575', NULL, '0', NULL, 'Color Inspector 3D', NULL, NULL, NULL, 'http://fiji.sc/Color_Inspector_3D', NULL),
('1581', NULL, '0', NULL, 'Celsius to fahrenheit', NULL, NULL, NULL, 'http://fiji.sc/Celsius_to_fahrenheit', NULL),
('1584', NULL, '0', NULL, 'Compaction Profiler', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Compaction_profiler', NULL),
('1595', NULL, '0', NULL, 'Cicardian Gene Expression', NULL, NULL, NULL, 'http://bigwww.epfl.ch/sage/soft/circadian', NULL),
('1624', NULL, '0', NULL, 'Clojure', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Clojure', NULL),
('1643', NULL, '0', NULL, 'Bilateral Filter', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1644', NULL, '0', NULL, 'Connected components XLS export Block', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Connected_components_XLS_export_Block', NULL),
('1648', NULL, '0', NULL, 'Colocalizer', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Colocalizer', NULL),
('1651', NULL, '0', NULL, 'Binary Image Operations', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1684', NULL, '0', NULL, 'Chart1DCanvas', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Chart1DCanvas', NULL),
('1710', NULL, '0', NULL, 'Colour Mode Conversion', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1727', NULL, '0', NULL, 'Complex toolbox', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Complex_toolbox', NULL),
('1735', NULL, '0', NULL, 'ClassifyObjects', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/ClassifyObjects.html', NULL),
('1762', NULL, '0', NULL, 'Colocalization Scatter Plot', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Colocalization_Scatter_Plot', NULL),
('1811', NULL, '0', NULL, 'Bounding Box 3D', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Bounding_Box_3D', NULL),
('1844', NULL, '0', NULL, 'ColorToGray', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/ColorToGray.html', NULL),
('1849', NULL, '0', NULL, 'Context Menu', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Context_Menu', NULL),
('1854', NULL, '0', NULL, 'Blob Detector', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Blob_Detector', NULL),
('1873', NULL, '0', NULL, 'Connected Component Analysis', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1918', NULL, '0', NULL, 'CLAHE', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1936', NULL, '0', NULL, 'Colour merge', NULL, NULL, NULL, 'http://fiji.sc/Colour_merge', NULL),
('1955', NULL, '0', NULL, 'CalculateMath', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/CalculateMath.html', NULL),
('1964', NULL, '0', NULL, 'CalculateStatistics', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/CalculateStatistics.html', NULL),
('1987', NULL, '0', NULL, 'Connected Components', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Connected_Components', NULL),
('1992', NULL, '0', NULL, 'CalculateImageOverlap', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/CalculateImageOverlap.html', NULL),
('1993', NULL, '0', NULL, 'Colocalization Test', NULL, NULL, NULL, 'http://fiji.sc/Colocalization_Test', NULL),
('1995', NULL, '0', NULL, 'Continuous-Time ARMA Identification', NULL, NULL, NULL, 'http://bigwww.epfl.ch/kirshner/software/arma/gaussian-maximum-likelihood/', NULL),
('2006', NULL, '0', NULL, 'Connected Component Painter', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Connected_Component_Painter', NULL),
('2043', NULL, '0', NULL, 'CMYK exporter', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/CMYK_exporter', NULL),
('2051', NULL, '0', NULL, 'Colocalization Threshold', NULL, NULL, NULL, 'http://fiji.sc/Colocalization_Threshold', NULL),
('2054', NULL, '0', NULL, 'Color Picker Threshold', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Color_Picker_Threshold', NULL),
('2056', NULL, '0', NULL, 'Channel Montage', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Channel_Montage', NULL),
('1444', NULL, '0', NULL, 'EnhanceOrSuppressFeatures', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/EnhanceOrSuppressFeatures.html', NULL),
('1454', NULL, '0', NULL, 'Contour Plot', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Contour_Plot', NULL),
('1496', NULL, '0', NULL, 'DefineGrid', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/DefineGrid.html', NULL),
('1538', NULL, '0', NULL, 'Event tutorial 1', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Event tutorial 1', NULL),
('1540', NULL, '0', NULL, 'EditObjectsManually', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/EditObjectsManually.html', NULL),
('1541', NULL, '0', NULL, 'Event tutorial 2', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Event tutorial 2', NULL),
('1542', NULL, '0', NULL, 'Edge Detection', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Edge_Detection', NULL),
('1551', NULL, '0', NULL, 'DisplayDataOnImage', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/DisplayDataOnImage.html', NULL),
('1559', NULL, '0', NULL, 'Count Chromosomes', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1566', NULL, '0', NULL, 'Elevation Map', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Elevation_Map', NULL),
('1576', NULL, '0', NULL, 'E-Snake', NULL, NULL, NULL, 'http://bigwww.epfl.ch/algorithms/esnake/', NULL),
('1578', NULL, '0', NULL, 'Debleach', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Debleach', NULL),
('1582', NULL, '0', NULL, 'Dynamic Reslice', NULL, NULL, NULL, 'http://fiji.sc/Dynamic_Reslice', NULL),
('1583', NULL, '0', NULL, 'Distortion Correction', NULL, NULL, NULL, 'http://fiji.sc/Distortion_Correction', NULL),
('1585', NULL, '0', NULL, 'Diffraction PSF 3D', NULL, NULL, NULL, 'http://fiji.sc/Diffraction_PSF_3D', NULL),
('1592', NULL, '0', NULL, 'Dynamic ROI Profiler', NULL, NULL, NULL, 'http://fiji.sc/Dynamic_ROI_Profiler', NULL),
('1603', NULL, '0', NULL, 'Diffusion Filters Tool', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Diffusion_Filters_Tool', NULL),
('1620', NULL, '0', NULL, 'Dimension Swapper', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1637', NULL, '0', NULL, 'E-splines', NULL, NULL, NULL, 'http://bigwww.epfl.ch/demo/Esplines/', NULL),
('1655', NULL, '0', NULL, 'Delaunay Voronoi', NULL, NULL, NULL, 'http://fiji.sc/Delaunay_Voronoi', NULL),
('1675', NULL, '0', NULL, 'Elastic Alignment and Montage', NULL, NULL, NULL, 'http://fiji.sc/Elastic_Alignment_and_Montage', NULL),
('1697', NULL, '0', NULL, 'DisplayDensityPlot', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/DisplayDensityPlot.html', NULL),
('1722', NULL, '0', NULL, 'CreateBatchFiles', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/CreateBatchFiles.html', NULL),
('1740', NULL, '0', NULL, 'Convolver', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1748', NULL, '0', NULL, 'ConvertObjectsToImage', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/ConvertObjectsToImage.html', NULL),
('1751', NULL, '0', NULL, 'DIPimage', NULL, NULL, NULL, 'http://www.diplib.org/', NULL),
('1760', NULL, '0', NULL, 'Dithering', NULL, NULL, NULL, 'http://fiji.sc/Dithering', NULL),
('1839', NULL, '0', NULL, 'DisplayHistogram', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/DisplayHistogram.html', NULL),
('1865', NULL, '0', NULL, 'Distance Map', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1884', NULL, '0', NULL, 'Convex Hull', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1914', NULL, '0', NULL, 'Distance Map Transform', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1929', NULL, '0', NULL, 'Crop 5D', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Crop_5D', NULL),
('1949', NULL, '0', NULL, 'Delayed Snapshot', NULL, NULL, NULL, 'http://fiji.sc/Delayed_Snapshot', NULL),
('1960', NULL, '0', NULL, 'Cover Maker', NULL, NULL, NULL, 'http://fiji.sc/Cover_Maker', NULL),
('1967', NULL, '0', NULL, 'CreaTools', NULL, NULL, NULL, 'http://www.creatis.insa-lyon.fr/site/en/CreaTools_home', NULL),
('1990', NULL, '0', NULL, 'CorrectIlluminationCalculate', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/CorrectIlluminationCalculate.html', NULL),
('1991', NULL, '0', NULL, 'Copy Pixel Size', NULL, NULL, NULL, 'http://fiji.sc/Copy_Pixel_Size', NULL),
('2002', NULL, '0', NULL, 'Crop', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/Crop.html', NULL),
('2020', NULL, '0', NULL, 'CorrectIlluminationApply', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/CorrectIlluminationApply.html', NULL),
('2021', NULL, '0', NULL, 'DisplayPlatemap', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/DisplayPlatemap.html', NULL),
('2024', NULL, '0', NULL, 'DisplayScatterPlot', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/DisplayScatterPlot.html', NULL),
('2034', NULL, '0', NULL, 'Contour Curvature', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('2050', NULL, '0', NULL, 'DeconvolutionLab', NULL, NULL, NULL, 'http://bigwww.epfl.ch/algorithms/deconvolution/', NULL),
('2070', NULL, '0', NULL, 'Drop Shape Analysis', NULL, NULL, NULL, 'http://bigwww.epfl.ch/demo/dropanalysis/', NULL),
('2095', NULL, '0', NULL, 'EnhanceEdges', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/EnhanceEdges.html', NULL),
('1461', NULL, '0', NULL, 'FFmpeg', NULL, NULL, NULL, 'www.ffmpeg.org', NULL),
('1490', NULL, '0', NULL, 'GUI tutorial 2', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/GUI tutorial 2', NULL),
('1533', NULL, '0', NULL, 'GUI tutorial 1', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/GUI tutorial 1', NULL),
('1539', NULL, '0', NULL, 'FilterObjects', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/FilterObjects.html', NULL),
('1549', NULL, '0', NULL, 'Fill Holes', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1635', NULL, '0', NULL, 'Fractional spline wavelet transform', NULL, NULL, NULL, 'http://bigwww.epfl.ch/demo/fractsplines/', NULL),
('1636', NULL, '0', NULL, 'Fill Holes', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1661', NULL, '0', NULL, 'Extended Depth of Field', NULL, NULL, NULL, 'http://fiji.sc/Extended_Depth_of_Field', NULL),
('1673', NULL, '0', NULL, 'Flying Camera', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Flying Camera', NULL),
('1677', NULL, '0', NULL, 'Extended Depth of Focus', NULL, NULL, NULL, 'http://bigwww.epfl.ch/demo/edf/', NULL),
('1704', NULL, '0', NULL, 'ExpandOrShrinkObjects', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/ExpandOrShrinkObjects.html', NULL),
('1711', NULL, '0', NULL, 'FijiArchipelago', NULL, NULL, NULL, 'http://fiji.sc/FijiArchipelago', NULL),
('1719', NULL, '0', NULL, 'FlipAndRotate', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/FlipAndRotate.html', NULL),
('1738', NULL, '0', NULL, 'File Import', NULL, NULL, NULL, 'http://fiji.sc/File_Import', NULL),
('1741', NULL, '0', NULL, 'Fast Fourier Transform', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Fast_Fourier_Transform', NULL),
('1766', NULL, '0', NULL, 'EzPlug Tutorial', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/EzPlug Tutorial', NULL),
('1768', NULL, '0', NULL, 'Fractional Splines and Fractals', NULL, NULL, NULL, 'http://bigwww.epfl.ch/demo/fractsplines-fractals/', NULL),
('1770', NULL, '0', NULL, 'Fractional Splines Wavelets', NULL, NULL, NULL, 'http://bigwww.epfl.ch/demo/fractsplines/', NULL),
('1781', NULL, '0', NULL, 'Generalized Riesz-Wavelet Toolbox for Matlab', NULL, NULL, NULL, 'http://bigwww.epfl.ch/demo/steerable-wavelets/', NULL),
('1808', NULL, '0', NULL, 'Generalized Daubechies wavelets', NULL, NULL, NULL, 'http://bigwww.epfl.ch/algorithms/generalized-daubechies/', NULL),
('1828', NULL, '0', NULL, 'FlowJ', NULL, NULL, NULL, 'http://fiji.sc/FlowJ', NULL),
('1830', NULL, '0', NULL, 'FlickrImageRetrieve', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/FlickrImageRetrieve', NULL),
('1840', NULL, '0', NULL, 'Fiji Logo 3D', NULL, NULL, NULL, 'http://fiji.sc/Fiji_Logo_3D', NULL),
('1855', NULL, '0', NULL, 'Find Dimension of Raw Image', NULL, NULL, NULL, 'http://fiji.sc/Find_Dimension_of_Raw_Image', NULL),
('1861', NULL, '0', NULL, 'Gaussian Convolution', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1871', NULL, '0', NULL, 'File Extension', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/File_extension', NULL),
('1879', NULL, '0', NULL, 'FlagImage', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/FlagImage.html', NULL),
('1887', NULL, '0', NULL, 'Generate a bug', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Generate a bug', NULL),
('1907', NULL, '0', NULL, 'Fill Regions', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1939', NULL, '0', NULL, 'Feature Calculation', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1940', NULL, '0', NULL, 'Extract Images From PDF', NULL, NULL, NULL, 'http://fiji.sc/Extract_Images_From_PDF...', NULL),
('1941', NULL, '0', NULL, 'ExportToDatabase', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/ExportToDatabase.html', NULL),
('1950', NULL, '0', NULL, 'Feature Detector', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Feature_Detector', NULL),
('1973', NULL, '0', NULL, 'Feature Extraction', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1998', NULL, '0', NULL, 'Fill holes in ROI', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Fill holes in ROI', NULL),
('2011', NULL, '0', NULL, 'Fill Holes (2D)', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Fill Holes (2D)', NULL),
('2015', NULL, '0', NULL, 'Gaussian noise estimator', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Gaussian noise estimator', NULL),
('2019', NULL, '0', NULL, 'EzPlug SDK', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/EzPlug_SDK', NULL),
('2041', NULL, '0', NULL, 'Fast Multilevel Thresholded-Landweber Deconvolution Algorithm', NULL, NULL, NULL, 'http://bigwww.epfl.ch/algorithms/mltldeconvolution/', NULL),
('2045', NULL, '0', NULL, 'ExportToSpreadsheet', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/ExportToSpreadsheet.html', NULL),
('2048', NULL, '0', NULL, 'Filter Toolbox', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Filter Toolbox', NULL),
('2075', NULL, '0', NULL, 'Gimp', NULL, NULL, NULL, 'www.gimp.org', NULL),
('1442', NULL, '0', NULL, 'Image Stitching', NULL, NULL, NULL, 'http://fiji.sc/Image_Stitching', NULL),
('1452', NULL, '0', NULL, 'Graph Cut', NULL, NULL, NULL, 'http://fiji.sc/Graph_Cut', NULL),
('1478', NULL, '0', NULL, 'Image process tutorial 1', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Image process tutorial 1', NULL),
('1505', NULL, '0', NULL, 'Grayscale Reconstruction', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1508', NULL, '0', NULL, 'ImageJ Macro', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1528', NULL, '0', NULL, 'Global Thresholder', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1532', NULL, '0', NULL, 'IdentifyObjectsManually', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/IdentifyObjectsManually.html', NULL),
('1555', NULL, '0', NULL, 'IdentifyTertiaryObjects', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/IdentifyTertiaryObjects.html', NULL),
('1565', NULL, '0', NULL, 'Image Cropper', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1568', NULL, '0', NULL, 'Icy diagnose', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Icy diagnose', NULL),
('1602', NULL, '0', NULL, 'ImageJ2', NULL, NULL, NULL, 'http://developer.imagej.net/', NULL),
('1691', NULL, '0', NULL, 'IdentifyDeadWorms', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/IdentifyDeadWorms.html', NULL),
('1698', NULL, '0', NULL, 'H2 database', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/H2 database', NULL),
('1714', NULL, '0', NULL, 'IdentifyObjectsInGrid', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/IdentifyObjectsInGrid.html', NULL),
('1720', NULL, '0', NULL, 'Image build tutorial 1', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Image build tutorial 1', NULL),
('1778', NULL, '0', NULL, 'Hex-splines', NULL, NULL, NULL, 'http://bigwww.epfl.ch/demo/hexsplines/', NULL),
('1788', NULL, '0', NULL, 'Image Differentials', NULL, NULL, NULL, 'http://bigwww.epfl.ch/thevenaz/differentials/', NULL),
('1799', NULL, '0', NULL, 'ImageMath', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/ImageMath.html', NULL),
('1817', NULL, '0', NULL, 'IdentifyPrimaryObjects', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/IdentifyPrimaryObjects.html', NULL),
('1829', NULL, '0', NULL, 'Image Converter', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1833', NULL, '0', NULL, 'Histogram', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Histogram', NULL),
('1853', NULL, '0', NULL, 'ISBI Tracking Challenge Batch Scoring', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/ISBI Tracking Challenge Batch Scoring', NULL),
('1856', NULL, '0', NULL, 'GraphCut 2D', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1862', NULL, '0', NULL, 'Image Writer', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1902', NULL, '0', NULL, 'Image Normalizer', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1906', NULL, '0', NULL, 'Hello world tutorial', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Hello world tutorial', NULL),
('1908', NULL, '0', NULL, 'ImageJ2 Plugin KNIME', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1912', NULL, '0', NULL, 'Image Reader', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1934', NULL, '0', NULL, 'Image Expression Parser', NULL, NULL, NULL, 'http://fiji.sc/Image_Expression_Parser', NULL),
('1947', NULL, '0', NULL, 'Grid', NULL, NULL, NULL, 'http://fiji.sc/Grid', NULL),
('1951', NULL, '0', NULL, 'Histogram Equalization', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Histogram Equalization', NULL),
('1977', NULL, '0', NULL, 'GrayToColor', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/GrayToColor.html', NULL),
('2014', NULL, '0', NULL, 'ImageBrowser', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/ImageBrowser', NULL),
('2027', NULL, '0', NULL, 'IdentifySecondaryObjects', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/IdentifySecondaryObjects.html', NULL),
('2029', NULL, '0', NULL, 'High-Content Screening', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('2046', NULL, '0', NULL, 'ISBI Challenge Tracks Importer', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/ISBI Challenge Tracks Importer', NULL),
('2066', NULL, '0', NULL, 'Image Calculator', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('2069', NULL, '0', NULL, 'Granulometric Filtering', NULL, NULL, NULL, 'http://fiji.sc/Granulometric_Filtering', NULL),
('2079', NULL, '0', NULL, 'Helmholtz Analysis', NULL, NULL, NULL, 'http://fiji.sc/Helmholtz_Analysis', NULL),
('1439', NULL, '0', NULL, 'ImarisIsoSurface', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/imaris', NULL),
('1445', NULL, '0', NULL, 'JavaDoc Parser', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/JavaDoc Parser', NULL),
('1448', NULL, '0', NULL, 'ImarisCell', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/imariscell', NULL),
('1470', NULL, '0', NULL, 'ImarisVolumeRendering', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/imaris', NULL),
('1486', NULL, '0', NULL, 'Jython Extras for Icy', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Jython Extras for Icy', NULL),
('1494', NULL, '0', NULL, 'Internet Connectivity Monitor', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Internet Connectivity Monitor', NULL),
('1504', NULL, '0', NULL, 'Integral Image Filters', NULL, NULL, NULL, 'http://fiji.sc/Integral_Image_Filters', NULL),
('1511', NULL, '0', NULL, 'Jython for Icy', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Jython for Icy', NULL),
('1517', NULL, '0', NULL, 'IsoData Classifier', NULL, NULL, NULL, 'http://fiji.sc/IsoData_Classifier', NULL),
('1562', NULL, '0', NULL, 'Larva-Tracking', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1616', NULL, '0', NULL, 'Inverter', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1629', NULL, '0', NULL, 'Invert', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Invert', NULL),
('1649', NULL, '0', NULL, 'ImarisAnnotate', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/imaris', NULL),
('1653', NULL, '0', NULL, 'ImarisSpots', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/imaris', NULL),
('1658', NULL, '0', NULL, 'ImgLib2', NULL, NULL, NULL, 'http://fiji.sc/wiki/index.php/ImgLib2', NULL),
('1685', NULL, '0', NULL, 'Jython execnet for Icy', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Jython execnet for Icy', NULL),
('1687', NULL, '0', NULL, 'Interactive Image Viewer', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1709', NULL, '0', NULL, 'Inkscape', NULL, NULL, NULL, 'inkscape.org', NULL),
('1716', NULL, '0', NULL, 'Kymographer', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Kymographer', NULL),
('1718', NULL, '0', NULL, 'Label Connected Objects', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1742', NULL, '0', NULL, 'InvertForPrinting', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/InvertForPrinting.html', NULL),
('1755', NULL, '0', NULL, 'ImarisTrack', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/imaristrack', NULL),
('1783', NULL, '0', NULL, 'Intramodal registration software', NULL, NULL, NULL, 'http://bigwww.epfl.ch/thevenaz/registration/', NULL),
('1798', NULL, '0', NULL, 'LabelImages', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/LabelImages.html', NULL),
('1805', NULL, '0', NULL, 'InputExternal', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/InputExternal.html', NULL),
('1813', NULL, '0', NULL, 'Interactive Stack Rotation', NULL, NULL, NULL, 'http://fiji.sc/Interactive_Stack_Rotation', NULL),
('1819', NULL, '0', NULL, 'Level Sets', NULL, NULL, NULL, 'http://fiji.sc/Level_Sets', NULL),
('1825', NULL, '0', NULL, 'ImarisBatch', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/imarisbatch', NULL),
('1827', NULL, '0', NULL, 'Landmark Correspondences', NULL, NULL, NULL, 'http://fiji.sc/Landmark_Correspondences', NULL),
('1845', NULL, '0', NULL, 'Kalman Stack Filter', NULL, NULL, NULL, 'http://fiji.sc/Kalman_Stack_Filter', NULL),
('1846', NULL, '0', NULL, 'ImarisVantage', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/imarisvantage', NULL),
('1869', NULL, '0', NULL, 'Interactive Annotator', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1890', NULL, '0', NULL, 'Intensity Profile', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Intensity Profile', NULL),
('1932', NULL, '0', NULL, 'Intensity Projection', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Intensity Projection', NULL),
('1952', NULL, '0', NULL, 'Import ROI from ImageJ', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Import ROI from ImageJ', NULL),
('1969', NULL, '0', NULL, 'KMeans Color Quantization', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/KMeans Color Quantization', NULL),
('1971', NULL, '0', NULL, 'Interactive Rigid', NULL, NULL, NULL, 'http://fiji.sc/Interactive_Rigid', NULL),
('1988', NULL, '0', NULL, 'ImarisColoc', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/imariscoloc', NULL),
('2044', NULL, '0', NULL, 'ImarisAnimation', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/imaris', NULL),
('2060', NULL, '0', NULL, 'ImarisFilamentTracer', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/filamenttracer', NULL),
('2067', NULL, '0', NULL, 'Interactive Moving Least Squares', NULL, NULL, NULL, 'http://fiji.sc/Interactive_Moving_Least_Squares', NULL),
('2077', NULL, '0', NULL, 'Iterative Deconvolve 3D', NULL, NULL, NULL, 'http://fiji.sc/Iterative_Deconvolve_3D', NULL),
('2078', NULL, '0', NULL, 'Interactive Similarity', NULL, NULL, NULL, 'http://fiji.sc/Interactive_Similarity', NULL),
('2083', NULL, '0', NULL, 'LSM Toolbox', NULL, NULL, NULL, 'http://fiji.sc/LSM_Toolbox', NULL),
('2089', NULL, '0', NULL, 'Interactive Affine', NULL, NULL, NULL, 'http://fiji.sc/Interactive_Affine', NULL),
('2092', NULL, '0', NULL, 'Interactive Perspective', NULL, NULL, NULL, 'http://fiji.sc/Interactive_Perspective', NULL),
('2093', NULL, '0', NULL, 'ImarisXT', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/imarisxt', NULL),
('1463', NULL, '0', NULL, 'LoadData', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/LoadData.html', NULL),
('1473', NULL, '0', NULL, 'List all threads', NULL, NULL, NULL, 'http://fiji.sc/List_all_threads', NULL),
('1476', NULL, '0', NULL, 'Manual TNT Annotation', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Manual TNT Annotation', NULL),
('1497', NULL, '0', NULL, 'MeasureNeurons', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/MeasureNeurons.html', NULL),
('1498', NULL, '0', NULL, 'Matlab IO', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Matlab IO', NULL),
('1506', NULL, '0', NULL, 'MeasureImageIntensity', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/MeasureImageIntensity.html', NULL),
('1510', NULL, '0', NULL, 'MaskObjects', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/MaskObjects.html', NULL),
('1519', NULL, '0', NULL, 'MeasureObjectIntensity', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/MeasureObjectIntensity.html', NULL),
('1529', NULL, '0', NULL, 'Make Fiji Package', NULL, NULL, NULL, 'http://fiji.sc/Make_Fiji_Package', NULL),
('1534', NULL, '0', NULL, 'LoadSingleImage', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/LoadSingleImage.html', NULL),
('1535', NULL, '0', NULL, 'Matlab function caller', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Matlab function caller', NULL),
('1537', NULL, '0', NULL, 'MaskImage', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/MaskImage.html', NULL),
('1545', NULL, '0', NULL, 'Local Normalization', NULL, NULL, NULL, 'http://bigwww.epfl.ch/sage/soft/localnormalization/', NULL),
('1547', NULL, '0', NULL, 'Ligand-Receptor ratio quantifier', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Ligand-Receptor ratio quantifier', NULL),
('1548', NULL, '0', NULL, 'MeasureImageAreaOccupied', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/MeasureImageAreaOccupied.html', NULL),
('1552', NULL, '0', NULL, 'Matlab blocks', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Matlab blocks', NULL),
('1553', NULL, '0', NULL, 'MeasureImageQuality', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/MeasureImageQuality.html', NULL),
('1589', NULL, '0', NULL, 'Linear Kuwahara', NULL, NULL, NULL, 'http://fiji.sc/Linear_Kuwahara', NULL),
('1625', NULL, '0', NULL, 'Mark Objects', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1639', NULL, '0', NULL, 'LoG Spot Detection (TrackMate)', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1683', NULL, '0', NULL, 'MaskEditor', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/MaskEditor', NULL),
('1706', NULL, '0', NULL, 'MeasureObjectNeighbors', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/MeasureObjectNeighbors.html', NULL),
('1721', NULL, '0', NULL, 'Maximum Finder', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1730', NULL, '0', NULL, 'Math operations', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Math operations', NULL),
('1736', NULL, '0', NULL, 'Log 2D canvas', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Log 2D canvas', NULL),
('1804', NULL, '0', NULL, 'MRI Simulation and Reconstruction', NULL, NULL, NULL, 'http://bigwww.epfl.ch/algorithms/mri-reconstruction/', NULL),
('1814', NULL, '0', NULL, 'Matlab X server', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Matlab X server', NULL),
('1842', NULL, '0', NULL, 'Matlab exporter', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Matlab exporter', NULL),
('1863', NULL, '0', NULL, 'Local Extrema', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Local Extrema', NULL),
('1881', NULL, '0', NULL, 'Measure Intensity', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1883', NULL, '0', NULL, 'Local Thresholding', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1896', NULL, '0', NULL, 'List plugins tutorial', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/List plugins tutorial', NULL),
('1905', NULL, '0', NULL, 'Math operations++', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Math_operations', NULL),
('1909', NULL, '0', NULL, 'Max Homogeneity', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1910', NULL, '0', NULL, 'Max Filter', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1948', NULL, '0', NULL, 'Local Thickness', NULL, NULL, NULL, 'http://fiji.sc/Local_Thickness', NULL),
('1953', NULL, '0', NULL, 'Matlab communicator', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Matlab communicator', NULL),
('1954', NULL, '0', NULL, 'MakeProjection', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/MakeProjection.html', NULL),
('1984', NULL, '0', NULL, 'MIJ', NULL, NULL, NULL, 'http://bigwww.epfl.ch/sage/soft/mij/', NULL),
('1997', NULL, '0', NULL, 'Matlab importer', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Matlab importer', NULL),
('2001', NULL, '0', NULL, 'MeasureCorrelation', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/MeasureCorrelation.html', NULL),
('2017', NULL, '0', NULL, 'MeasureGranularity', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/MeasureGranularity.html', NULL),
('2030', NULL, '0', NULL, 'Magnifier', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Magnifier', NULL),
('2036', NULL, '0', NULL, 'MTrack2', NULL, NULL, NULL, 'http://fiji.sc/MTrack2', NULL),
('2038', NULL, '0', NULL, 'Linear Stack Alignment with SIFT', NULL, NULL, NULL, 'http://fiji.sc/Linear_Stack_Alignment_with_SIFT', NULL),
('2053', NULL, '0', NULL, 'LoadImages', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/LoadImages.html', NULL),
('1460', NULL, '0', NULL, 'Morphological Operations', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1482', NULL, '0', NULL, 'Microscopy Blocks', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Microscopy Blocks', NULL),
('1484', NULL, '0', NULL, 'MergeOutputFiles', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/MergeOutputFiles.html', NULL),
('1491', NULL, '0', NULL, 'Multi-Touch provider', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Multi-Touch provider', NULL),
('1500', NULL, '0', NULL, 'Middlebur Coler Coder', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Middlebury_Color_Coder', NULL),
('1509', NULL, '0', NULL, 'Microscope Live', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Microscope Live', NULL),
('1543', NULL, '0', NULL, 'MereoTopology', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/MereoTopology', NULL),
('1638', NULL, '0', NULL, 'Micro-Manager for Icy', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Micro-Manager for Icy', NULL),
('1647', NULL, '0', NULL, 'Multilevel Thresholding', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1668', NULL, '0', NULL, 'Mice Profiler Label Analyser', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Mice_Profiler_Label_Analyser', NULL),
('1669', NULL, '0', NULL, 'Mice Profiler Tracker', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Mice_Profiler_Tracker', NULL),
('1679', NULL, '0', NULL, 'Mice Profiler Video Label Maker', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Mice_Profiler_Video_Label_Maker', NULL),
('1681', NULL, '0', NULL, 'MonogenicJ', NULL, NULL, NULL, 'http://bigwww.epfl.ch/demo/monogenicj/', NULL),
('1682', NULL, '0', NULL, 'Microscope Remote', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Microscope Remote', NULL),
('1689', NULL, '0', NULL, 'Microscope Snapper', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Microscope Snapper', NULL),
('1690', NULL, '0', NULL, 'Median Filter', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1695', NULL, '0', NULL, 'Merger', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1696', NULL, '0', NULL, 'Microscope Advanced Acquisition', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Microscope_Advanced_Acquisition', NULL),
('1715', NULL, '0', NULL, 'Multithreaded Image Processing in Javascript', NULL, NULL, NULL, 'http://fiji.sc/Multithreaded_Image_Processing_in_Javascript', NULL),
('1723', NULL, '0', NULL, 'Multithreaded Image Processing', NULL, NULL, NULL, 'http://fiji.sc/Multithreaded_Image_Processing', NULL),
('1724', NULL, '0', NULL, 'MeasureObjectRadialDistribution', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/MeasureObjectRadialDistribution.html', NULL),
('1729', NULL, '0', NULL, 'Microscope Calibrator Manager', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Microscope Calibrator Manager', NULL),
('1734', NULL, '0', NULL, 'Microscope Calibrator Pixel Size', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Microscope Calibrator Pixel Size', NULL),
('1747', NULL, '0', NULL, 'Multiple Image Processor', NULL, NULL, NULL, 'http://fiji.sc/Multiple_Image_Processor', NULL),
('1764', NULL, '0', NULL, 'MorphoMaths', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/MorphoMaths', NULL),
('1820', NULL, '0', NULL, 'Multi Otsu Threshold', NULL, NULL, NULL, 'http://fiji.sc/Multi_Otsu_Threshold', NULL),
('1822', NULL, '0', NULL, 'Mophological Image Operations', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1834', NULL, '0', NULL, 'Multi-touch gestures', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Multi-touch gestures', NULL),
('1860', NULL, '0', NULL, 'Miniature Faking', NULL, NULL, NULL, 'http://fiji.sc/Miniature_Faking', NULL),
('1874', NULL, '0', NULL, 'Merge Images', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1875', NULL, '0', NULL, 'Moving Blobs Generator', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Moving Blobs Generator', NULL),
('1878', NULL, '0', NULL, 'Montage 2D', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Montage 2D', NULL),
('1886', NULL, '0', NULL, 'Min Filter', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1889', NULL, '0', NULL, 'Membrane Filter', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Membrane Filter', NULL),
('1891', NULL, '0', NULL, 'MicroManagerLibs', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/MicroManagerLibs', NULL),
('1901', NULL, '0', NULL, 'Median Filter', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1903', NULL, '0', NULL, 'MultiThresholder', NULL, NULL, NULL, 'http://fiji.sc/MultiThresholder', NULL),
('1904', NULL, '0', NULL, 'Median Filter', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Median Filter', NULL),
('1915', NULL, '0', NULL, 'Mycosis Lung Quantifier', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Mycosis Lung Quantifier', NULL),
('1946', NULL, '0', NULL, 'Microscope Live 3D', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Microscope_Live_3D', NULL),
('1972', NULL, '0', NULL, 'Moving Least Squares', NULL, NULL, NULL, 'http://fiji.sc/Moving_Least_Squares', NULL),
('2018', NULL, '0', NULL, 'Micormanager for Icy', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Micro-Manager_for_Icy', NULL),
('2032', NULL, '0', NULL, 'MeasureTexture', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/MeasureTexture.html', NULL),
('2058', NULL, '0', NULL, 'Mixture Modeling Thresholding', NULL, NULL, NULL, 'http://fiji.sc/Mixture_Modeling_Thresholding', NULL),
('2080', NULL, '0', NULL, 'MosaicJ', NULL, NULL, NULL, 'http://bigwww.epfl.ch/thevenaz/mosaicj/', NULL),
('2084', NULL, '0', NULL, 'Morph', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/Morph.html', NULL),
('2096', NULL, '3', NULL, 'MeasureObjectSizeShape', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/MeasureObjectSizeShape.html', NULL),
('1449', NULL, '0', NULL, 'Pink / Histogram Based Operators', NULL, NULL, NULL, 'https://pinkhq.com', NULL),
('1455', NULL, '0', NULL, 'Pink / Three Dimensional Meshing', NULL, NULL, NULL, 'https://pinkhq.com', NULL),
('1465', NULL, '0', NULL, 'NeuronJ', NULL, NULL, NULL, 'http://www.imagescience.org/meijering/software/neuronj/', NULL),
('1512', NULL, '0', NULL, 'PDE Shock Filter', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/PDE Shock Filter', NULL),
('1516', NULL, '0', NULL, 'Overlay tutorial 2', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Overlay tutorial 2', NULL),
('1520', NULL, '0', NULL, 'PSF Generator', NULL, NULL, NULL, 'http://bigwww.epfl.ch/algorithms/psfgenerator', NULL),
('1523', NULL, '0', NULL, 'Overlay tutorial 1', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Overlay tutorial 1', NULL),
('1536', NULL, '0', NULL, 'OpenCL Lab', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/OpenCL Lab', NULL),
('1569', NULL, '0', NULL, 'Non-linear Filter', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Non-linear Filter', NULL),
('1594', NULL, '0', NULL, 'Pink / Format and Type Conversions', NULL, NULL, NULL, 'https://pinkhq.com', NULL),
('1605', NULL, '0', NULL, 'NHerve Toolbox', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/NHerve_Toolbox', NULL),
('1606', NULL, '0', NULL, 'Pink / Digital Topology', NULL, NULL, NULL, 'https://pinkhq.com', NULL),
('1614', NULL, '0', NULL, 'Pink / Signal Processing', NULL, NULL, NULL, 'https://pinkhq.com', NULL),
('1615', NULL, '0', NULL, 'Pink / Orders Topology', NULL, NULL, NULL, 'https://pinkhq.com', NULL),
('1619', NULL, '0', NULL, 'NHerve ImageAnalysis Toolbox', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/NHerve ImageAnalysis Toolbox', NULL),
('1626', NULL, '0', NULL, 'Painting', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Painting', NULL),
('1632', NULL, '0', NULL, 'PTR335 Slope Computation', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/PTR335 Slope Computation', NULL),
('1640', NULL, '0', NULL, 'NHerve Matrix', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/NHerve Matrix', NULL),
('1663', NULL, '0', NULL, 'PIV analyser', NULL, NULL, NULL, 'http://fiji.sc/PIV_analyser', NULL),
('1678', NULL, '0', NULL, 'Otsu Thresholding', NULL, NULL, NULL, 'http://fiji.sc/Otsu_Thresholding', NULL),
('1728', NULL, '0', NULL, 'Name Landmarks and Register', NULL, NULL, NULL, 'http://fiji.sc/Name_Landmarks_and_Register', NULL),
('1744', NULL, '0', NULL, 'Particle tracking benchmark generator', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Particle tracking benchmark generator', NULL),
('1752', NULL, '0', NULL, 'Particle Tracker', NULL, NULL, NULL, 'http://fiji.sc/Particle_Tracker', NULL);
INSERT INTO `entity` (`id_entity`, `id_user_skill`, `id_curator`, `id_paper`, `Title`, `Body`, `Authors`, `Training material`, `LocationPath`, `ImagePath`) VALUES
('1769', NULL, '0', NULL, 'PatternQuant', NULL, NULL, NULL, 'http://www.3dhistech.com/patternquant_module', NULL),
('1771', NULL, '0', NULL, 'PauseCellProfiler', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/PauseCellProfiler.html', NULL),
('1773', NULL, '0', NULL, 'Nyquist Sampling Calculator', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Nyquist_Sampling_Calculator', NULL),
('1803', NULL, '0', NULL, 'OutputExternal', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/OutputExternal.html', NULL),
('1823', NULL, '0', NULL, 'Parallel Spectral Deconvolution', NULL, NULL, NULL, 'http://fiji.sc/Parallel_Spectral_Deconvolution', NULL),
('1841', NULL, '0', NULL, 'OrientationJ', NULL, NULL, NULL, 'http://bigwww.epfl.ch/demo/orientation/', NULL),
('1847', NULL, '0', NULL, 'PixBleach', NULL, NULL, NULL, 'http://bigwww.epfl.ch/algorithms/pixbleach/', NULL),
('1848', NULL, '0', NULL, 'Parallel Iterative Deconvolution', NULL, NULL, NULL, 'http://fiji.sc/Parallel_Iterative_Deconvolution', NULL),
('1885', NULL, '0', NULL, 'Particles animation', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Particles animation', NULL),
('1895', NULL, '0', NULL, 'Noise generator', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Noise generator', NULL),
('1921', NULL, '0', NULL, 'Pink / Geometrical Operators', NULL, NULL, NULL, 'https://pinkhq.com', NULL),
('1922', NULL, '0', NULL, 'Pink / Mathematical Morphology', NULL, NULL, NULL, 'https://pinkhq.com', NULL),
('1925', NULL, '0', NULL, 'Pink / Digital Connectivity', NULL, NULL, NULL, 'https://pinkhq.com', NULL),
('1927', NULL, '0', NULL, 'Pink / Interactive Operatos', NULL, NULL, NULL, 'https://pinkhq.com', NULL),
('1965', NULL, '0', NULL, 'Pink / Statistics', NULL, NULL, NULL, 'https://pinkhq.com', NULL),
('1978', NULL, '0', NULL, 'Oriented Contours', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1980', NULL, '0', NULL, 'Ovuscule', NULL, NULL, NULL, 'http://bigwww.epfl.ch/thevenaz/ovuscule/', NULL),
('1996', NULL, '0', NULL, 'OverlayOutlines', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/OverlayOutlines.html', NULL),
('2010', NULL, '0', NULL, 'Pink / Segmentation', NULL, NULL, NULL, 'https://pinkhq.com', NULL),
('2042', NULL, '0', NULL, 'Pink / Graphic Primitives', NULL, NULL, NULL, 'https://pinkhq.com', NULL),
('2057', NULL, '0', NULL, 'Pink / Visualization', NULL, NULL, NULL, 'https://pinkhq.com', NULL),
('1443', NULL, '0', NULL, 'Resize', NULL, NULL, NULL, 'http://bigwww.epfl.ch/algorithms/ijplugins/resize/', NULL),
('1462', NULL, '0', NULL, 'RATS: Robust Automatic Threshold Selection', NULL, NULL, NULL, 'http://fiji.sc/RATS:_Robust_Automatic_Threshold_Selection', NULL),
('1474', NULL, '0', NULL, 'RGB Measure Plus', NULL, NULL, NULL, 'http://fiji.sc/RGB_Measure_Plus', NULL),
('1483', NULL, '0', NULL, 'RGB Profiler', NULL, NULL, NULL, 'http://fiji.sc/RGB_Profiler', NULL),
('1488', NULL, '0', NULL, 'Replace Red with Magenta', NULL, NULL, NULL, 'http://fiji.sc/Replace_Red_with_Magenta', NULL),
('1492', NULL, '0', NULL, 'ROI Pool', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/ROI Pool', NULL),
('1502', NULL, '0', NULL, 'Rhino Library', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Rhino Library', NULL),
('1503', NULL, '0', NULL, 'Ring ROI', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Ring ROI', NULL),
('1507', NULL, '0', NULL, 'Rectangular Finite Elements', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Rectangular Finite Elements', NULL),
('1518', NULL, '0', NULL, 'ROI Measures', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/ROI Measures', NULL),
('1522', NULL, '0', NULL, 'Resize', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/Resize.html', NULL),
('1546', NULL, '0', NULL, 'Resampler', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1563', NULL, '0', NULL, 'ROI color coding', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/ROI color coding', NULL),
('1567', NULL, '0', NULL, 'ROI tutorial 1', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/ROI tutorial 1', NULL),
('1598', NULL, '0', NULL, 'PlugIn Design Guidelines', NULL, NULL, NULL, 'http://fiji.sc/PlugIn_Design_Guidelines', NULL),
('1601', NULL, '0', NULL, 'Processing', NULL, NULL, NULL, 'http://processing.org/', NULL),
('1645', NULL, '0', NULL, 'Realistic Analytical Phantoms for Parallel MRI', NULL, NULL, NULL, 'http://bigwww.epfl.ch/algorithms/mriphantom/', NULL),
('1646', NULL, '0', NULL, 'Projector', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1686', NULL, '0', NULL, 'ROI image process tutorial 2', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/ROI image process tutorial 2', NULL),
('1693', NULL, '0', NULL, 'ROI image process tutorial 1', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/ROI image process tutorial 1', NULL),
('1705', NULL, '0', NULL, 'RunImageJ', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/RunImageJ.html', NULL),
('1707', NULL, '0', NULL, 'Report a Bug', NULL, NULL, NULL, 'http://fiji.sc/Report_a_Bug', NULL),
('1713', NULL, '0', NULL, 'Protractor', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Protractor', NULL),
('1717', NULL, '0', NULL, 'Reconstruct Reader', NULL, NULL, NULL, 'http://fiji.sc/Reconstruct_Reader', NULL),
('1726', NULL, '0', NULL, 'Point Picker', NULL, NULL, NULL, 'http://bigwww.epfl.ch/thevenaz/pointpicker/', NULL),
('1838', NULL, '0', NULL, 'Probabilistic particle tracker', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Probabilistic particle tracker', NULL),
('1852', NULL, '0', NULL, 'SPIM Bead Registration', NULL, NULL, NULL, 'http://fiji.sc/SPIM_Bead_Registration_(deprecated)', NULL),
('1857', NULL, '0', NULL, 'ROI ToolTip', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/ROI ToolTip', NULL),
('1864', NULL, '0', NULL, 'PixFRET', NULL, NULL, NULL, 'http://www.unil.ch/cig/page16989.html', NULL),
('1867', NULL, '0', NULL, 'ROI Tagger', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/ROI Tagger', NULL),
('1880', NULL, '0', NULL, 'Remove Objects', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1897', NULL, '0', NULL, 'Pixtastic', NULL, NULL, NULL, 'http://www.pixastic.com/', NULL),
('1899', NULL, '0', NULL, 'RenameOrRenumberFiles', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/RenameOrRenumberFiles.html', NULL),
('1913', NULL, '0', NULL, 'Quantile Filter', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1942', NULL, '0', NULL, 'SIOX: Simple Interactive Object Extraction', NULL, NULL, NULL, 'http://fiji.sc/SIOX:_Simple_Interactive_Object_Extraction', NULL),
('1943', NULL, '0', NULL, 'RodCellJ', NULL, NULL, NULL, 'http://bigwww.epfl.ch/algorithms/rodcellj/', NULL),
('1963', NULL, '0', NULL, 'Projection', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Projection', NULL),
('1979', NULL, '0', NULL, 'RescaleIntensity', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/RescaleIntensity.html', NULL),
('1981', NULL, '0', NULL, 'ROI Intensity Evolution', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/ROI Intensity Evolution', NULL),
('2008', NULL, '0', NULL, 'Ruler Helper', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Ruler Helper', NULL),
('2012', NULL, '0', NULL, 'Protractor ROI Cutter', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Protractor ROI Cutter', NULL),
('2064', NULL, '0', NULL, 'RGB to Montage', NULL, NULL, NULL, 'http://fiji.sc/RGB_to_Montage', NULL),
('2068', NULL, '0', NULL, 'Retinex', NULL, NULL, NULL, 'http://fiji.sc/Retinex', NULL),
('2071', NULL, '0', NULL, 'RGB-Gray Merge', NULL, NULL, NULL, 'http://fiji.sc/RGB-Gray_Merge', NULL),
('2085', NULL, '0', NULL, 'Protocols SDK', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Protocols SDK', NULL),
('2088', NULL, '0', NULL, 'Protocols', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Protocols', NULL),
('1464', NULL, '0', NULL, 'SaveImages', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/SaveImages.html', NULL),
('1525', NULL, '0', NULL, 'Script Block v1', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Script Block v1', NULL),
('1530', NULL, '0', NULL, 'Spot Detector', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Spot Detector', NULL),
('1557', NULL, '0', NULL, 'Slice Traveler', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Slice Traveler', NULL),
('1564', NULL, '0', NULL, 'Sequence Blocks', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Sequence Blocks', NULL),
('1593', NULL, '0', NULL, 'SpotTracker', NULL, NULL, NULL, 'http://bigwww.epfl.ch/sage/soft/spottracker/', NULL),
('1609', NULL, '0', NULL, 'Sholl Analysis', NULL, NULL, NULL, 'http://fiji.sc/Sholl_Analysis', NULL),
('1621', NULL, '0', NULL, 'Segment Cropper', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1622', NULL, '0', NULL, 'SURE-LET Wavelet Denoising', NULL, NULL, NULL, 'http://bigwww.epfl.ch/demo/suredenoising/', NULL),
('1627', NULL, '0', NULL, 'Spline Interpolation', NULL, NULL, NULL, 'http://bigwww.epfl.ch/thevenaz/interpolation/', NULL),
('1634', NULL, '0', NULL, 'SheppLogan', NULL, NULL, NULL, 'http://bigwww.epfl.ch/thevenaz/shepplogan/', NULL),
('1692', NULL, '0', NULL, 'Screen shot', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Screen shot', NULL),
('1703', NULL, '0', NULL, 'Save as animated gif', NULL, NULL, NULL, 'http://fiji.sc/Save_as_animated_gif', NULL),
('1712', NULL, '0', NULL, 'Scale Bar', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Scale Bar', NULL),
('1731', NULL, '0', NULL, 'Sequence comparator', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Sequence comparator', NULL),
('1732', NULL, '0', NULL, 'Splash Screen Maker', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Splash Screen Maker', NULL),
('1733', NULL, '0', NULL, 'Spheres and Tubes in 3D', NULL, NULL, NULL, 'http://fiji.sc/Spheres_and_Tubes_in_3D', NULL),
('1774', NULL, '0', NULL, 'SendEmail', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/SendEmail.html', NULL),
('1777', NULL, '0', NULL, 'Spline Pyramids Software', NULL, NULL, NULL, 'http://bigwww.epfl.ch/sage/pyramids/', NULL),
('1793', NULL, '0', NULL, 'Shifted-Linear Interpolation', NULL, NULL, NULL, 'http://bigwww.epfl.ch/thevenaz/shiftedlin/', NULL),
('1810', NULL, '0', NULL, 'SciJava', NULL, NULL, NULL, 'http://www.scijava.org/', NULL),
('1821', NULL, '0', NULL, 'Simulate Color Blindness', NULL, NULL, NULL, 'http://fiji.sc/Simulate_Color_Blindness', NULL),
('1858', NULL, '0', NULL, 'Splitter', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1859', NULL, '0', NULL, 'SSIM toolbox', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/SSIM toolbox', NULL),
('1868', NULL, '0', NULL, 'Sigma Filter', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1872', NULL, '0', NULL, 'Sobel Filter', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1876', NULL, '0', NULL, 'Shepp-Logan Phantom', NULL, NULL, NULL, 'http://fiji.sc/Shepp-Logan_Phantom_(Plugin)', NULL),
('1877', NULL, '0', NULL, 'Same Slice in Multiple Images', NULL, NULL, NULL, 'http://fiji.sc/Same_Slice_in_Multiple_Images', NULL),
('1882', NULL, '0', NULL, 'Spot Detection', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1892', NULL, '0', NULL, 'Seg3D', NULL, NULL, NULL, 'http://www.sci.utah.edu/cibc-software/seg3d.html', NULL),
('1894', NULL, '0', NULL, 'Simple Operations', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Simple Operations', NULL),
('1898', NULL, '0', NULL, 'Spot detection utilities', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Spot detection utilities', NULL),
('1933', NULL, '0', NULL, 'SPIM Registration Method', NULL, NULL, NULL, 'http://fiji.sc/SPIM_Registration_Method', NULL),
('1937', NULL, '0', NULL, 'Snakuscule', NULL, NULL, NULL, 'http://bigwww.epfl.ch/thevenaz/snakuscule/', NULL),
('1956', NULL, '0', NULL, 'Segmentation Editor', NULL, NULL, NULL, 'http://fiji.sc/Segmentation_Editor', NULL),
('1957', NULL, '0', NULL, 'Shape Index Map', NULL, NULL, NULL, 'http://fiji.sc/Shape_Index_Map', NULL),
('1958', NULL, '0', NULL, 'Simple Neurite Tracer', NULL, NULL, NULL, 'http://fiji.sc/Simple_Neurite_Tracer', NULL),
('1962', NULL, '0', NULL, 'Sigma Filter', NULL, NULL, NULL, 'http://fiji.sc/Sigma_Filter', NULL),
('1968', NULL, '0', NULL, 'Spline Deformation Generator', NULL, NULL, NULL, 'http://fiji.sc/Spline_Deformation_Generator', NULL),
('1970', NULL, '0', NULL, 'Script Editor', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Script Editor', NULL),
('1985', NULL, '0', NULL, 'Spatial Transformations', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1999', NULL, '0', NULL, 'Slice Labeler', NULL, NULL, NULL, 'http://fiji.sc/Slice_Labeler', NULL),
('2025', NULL, '0', NULL, 'Seeded Watershed', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('2033', NULL, '0', NULL, 'Series Labeler', NULL, NULL, NULL, 'http://fiji.sc/Series_Labeler', NULL),
('2059', NULL, '0', NULL, 'Stack Manipulation', NULL, NULL, NULL, 'http://fiji.sc/Stack_Manipulation', NULL),
('1458', NULL, '0', NULL, 'TrackMate', NULL, NULL, NULL, 'http://fiji.sc/TrackMate', NULL),
('1475', NULL, '0', NULL, 'Tile Images', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1480', NULL, '0', NULL, 'Test Java3D', NULL, NULL, NULL, 'http://fiji.sc/Test_Java3D', NULL),
('1485', NULL, '0', NULL, 'Thresholded pixel density', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Thresholded pixel density', NULL),
('1489', NULL, '0', NULL, 'Texture Segmentation', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Texture Segmentation', NULL),
('1493', NULL, '0', NULL, 'Sync Windows', NULL, NULL, NULL, 'http://fiji.sc/Sync_Windows', NULL),
('1514', NULL, '0', NULL, 'Substract ROI', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Substract ROI', NULL),
('1524', NULL, '0', NULL, 'Thresholder', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Thresholder', NULL),
('1554', NULL, '0', NULL, 'TrackObjects', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/TrackObjects.html', NULL),
('1558', NULL, '0', NULL, 'Swimming Pool Emitter', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Swimming Pool Emitter', NULL),
('1561', NULL, '0', NULL, 'Swimming Pool Listener', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Swimming Pool Listener', NULL),
('1570', NULL, '0', NULL, 'Stack Rotation', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Stack Rotation', NULL),
('1597', NULL, '0', NULL, 'Stitching 2D/3D', NULL, NULL, NULL, 'http://fiji.sc/Stitching_2D/3D', NULL),
('1618', NULL, '0', NULL, 'Tile', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/Tile.html', NULL),
('1630', NULL, '0', NULL, 'Stack Objects', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1642', NULL, '0', NULL, 'Swap Image Dimensions', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1650', NULL, '0', NULL, 'SteerableJ', NULL, NULL, NULL, 'http://bigwww.epfl.ch/demo/steerable/', NULL),
('1674', NULL, '0', NULL, 'Stochastic Denoising', NULL, NULL, NULL, 'http://fiji.sc/Stochastic_Denoising', NULL),
('1680', NULL, '0', NULL, 'StraightenWorms', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/StraightenWorms.html', NULL),
('1688', NULL, '0', NULL, 'Stack Rotation by Angle', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Stack Rotation by Angle', NULL),
('1745', NULL, '0', NULL, 'StackReg', NULL, NULL, NULL, 'http://bigwww.epfl.ch/thevenaz/stackreg/', NULL),
('1787', NULL, '0', NULL, 'Symmetric Exponential B-spline', NULL, NULL, NULL, 'http://bigwww.epfl.ch/kirshner/software/sym-exp-spline/', NULL),
('1812', NULL, '0', NULL, 'Track Processor Time Clip', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Track Processor Time Clip', NULL),
('1815', NULL, '0', NULL, 'Track Processor ROI Gate', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Track Processor ROI Gate', NULL),
('1816', NULL, '0', NULL, 'Track Processor Track Length', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Track Processor Track Length', NULL),
('1831', NULL, '0', NULL, 'Track Processor Z Clip', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Track Processor Z Clip', NULL),
('1836', NULL, '0', NULL, 'Stereo Viewer', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Stereo_Viewer', NULL),
('1837', NULL, '0', NULL, 'Track Processor Speed Profiler', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Track Processor Speed Profiler', NULL),
('1870', NULL, '0', NULL, 'SteerableJ', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/SteerableJ', NULL),
('1900', NULL, '0', NULL, 'StatColoc', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/StatColoc', NULL),
('1928', NULL, '0', NULL, 'Trainable Segmentation Plugin Implementation', NULL, NULL, NULL, 'http://fiji.sc/Trainable_Segmentation_Plugin_Implementation', NULL),
('1935', NULL, '0', NULL, 'Trainable Segmentation Plugin', NULL, NULL, NULL, 'http://fiji.sc/Trainable_Segmentation_Plugin_(deprecated)', NULL),
('1961', NULL, '0', NULL, 'Straighten', NULL, NULL, NULL, 'http://fiji.sc/Straighten...', NULL),
('1966', NULL, '0', NULL, 'Statistical Region Merging', NULL, NULL, NULL, 'http://fiji.sc/Statistical_Region_Merging', NULL),
('1982', NULL, '0', NULL, 'Track Processor Instant Speed', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Track Processor Instant Speed', NULL),
('1983', NULL, '0', NULL, 'Track Processor Intensity Profile', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Track Processor Intensity Profile', NULL),
('2004', NULL, '0', NULL, 'Track Processor Color', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Track Processor Color', NULL),
('2005', NULL, '0', NULL, 'Track Processor Zero Origin', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Track Processor Zero Origin', NULL),
('2007', NULL, '0', NULL, 'Tracking Performance Measures', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Tracking Performance Measures', NULL),
('2009', NULL, '0', NULL, 'Syntax Highlighting', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Syntax Highlighting', NULL),
('2016', NULL, '0', NULL, 'TimeStamp Overlay', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/TimeStamp Overlay', NULL),
('2022', NULL, '0', NULL, 'Track Processor MSD', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Track Processor MSD', NULL),
('2023', NULL, '0', NULL, 'Time Stamper', NULL, NULL, NULL, 'http://fiji.sc/Time_Stamper', NULL),
('2026', NULL, '0', NULL, 'Track Processor Display Track Number', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Track Processor Display Track Number', NULL),
('2028', NULL, '0', NULL, 'Track Manager', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Track Manager', NULL),
('2031', NULL, '0', NULL, 'Track Processor export track to Excel', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Track Processor export track to Excel', NULL),
('2039', NULL, '0', NULL, 'Track Processor Flow', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Track Processor Flow', NULL),
('2052', NULL, '0', NULL, 'TopoJ', NULL, NULL, NULL, 'http://fiji.sc/TopoJ', NULL),
('2072', NULL, '0', NULL, 'Strahler Analysis', NULL, NULL, NULL, 'http://fiji.sc/Strahler_Analysis', NULL),
('2086', NULL, '0', NULL, 'Temporal-Color Code', NULL, NULL, NULL, 'http://fiji.sc/Temporal-Color_Code', NULL),
('1451', NULL, '0', NULL, 'UnmixColors', NULL, NULL, NULL, 'http://www.cellprofiler.org/CPmanual/UnmixColors.html', NULL),
('1481', NULL, '0', NULL, 'Video Recorder', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Video Recorder', NULL),
('1487', NULL, '0', NULL, 'h-dome Extraction', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1495', NULL, '0', NULL, 'Video Importer', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Video Importer', NULL),
('1515', NULL, '0', NULL, 'UDWT Wavelet Residual Remover', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/UDWT Wavelet Residual Remover', NULL),
('1550', NULL, '0', NULL, 'Voronoi Segmentation', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1556', NULL, '0', NULL, 'Update Fiji', NULL, NULL, NULL, 'http://fiji.sc/Update_Fiji', NULL),
('1571', NULL, '0', NULL, 'Upload Sample Image', NULL, NULL, NULL, 'http://fiji.sc/Upload_Sample_Image', NULL),
('1599', NULL, '0', NULL, 'VLC media player', NULL, NULL, NULL, 'www.videolan.org', NULL),
('1617', NULL, '0', NULL, 'Wspm', NULL, NULL, NULL, 'http://miplab.epfl.ch/wspm/', NULL),
('1701', NULL, '0', NULL, 'Voronoi Segmentation', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1708', NULL, '0', NULL, 'Watershed Segmentation', NULL, NULL, NULL, 'http://www.bioconductor.org/packages/release/bioc/manuals/EBImage/man/EBImage.pdf', NULL),
('1725', NULL, '0', NULL, 'VTK overlay tutorial', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/VTK overlay tutorial', NULL),
('1739', NULL, '3', NULL, 'UntangleWorms', 'C.elegans will often lie next to each other or cross, forming a tangle of worms in an image. This module will segment them, based on a model, to untangle the individual worms so that they can be treated as if they did not overlap.', NULL, NULL, 'http://www.cellprofiler.org/CPmanual/UntangleWorms.html', NULL),
('1743', NULL, '0', NULL, 'Volocity Visualization', NULL, NULL, NULL, 'http://www.perkinelmer.com/pages/020/cellularimaging/products/volocityvisualization.xhtml', NULL),
('1754', NULL, '0', NULL, 'Volocity Quantification', NULL, NULL, NULL, 'http://www.perkinelmer.com/pages/020/cellularimaging/products/volocityquantitation.xhtml', NULL),
('1809', NULL, '0', NULL, 'pythonxy', NULL, NULL, NULL, 'https://code.google.com/p/pythonxy/', NULL),
('1824', NULL, '0', NULL, 'TrakEM2', NULL, NULL, NULL, 'http://www.ini.uzh.ch/~acardona/trakem2.html', NULL),
('1835', NULL, '0', NULL, 'Using the Script Editor', NULL, NULL, NULL, 'http://fiji.sc/Using_the_Script_Editor', NULL),
('1850', NULL, '0', NULL, 'View5D', NULL, NULL, NULL, 'http://fiji.sc/View5D', NULL),
('1866', NULL, '0', NULL, 'Variance Filter', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('1911', NULL, '0', NULL, 'Widefield Fluorescence Microscope PSF', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Widefield Fluorescence Microscope PSF', NULL),
('1917', NULL, '0', NULL, 'Workspace Editor', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Workspace Editor', NULL),
('1931', NULL, '0', NULL, 'Transform Virtual Stack Slices', NULL, NULL, NULL, 'http://fiji.sc/Transform_Virtual_Stack_Slices', NULL),
('1986', NULL, '0', NULL, 'UnwarpJ', NULL, NULL, NULL, 'http://bigwww.epfl.ch/thevenaz/UnwarpJ/', NULL),
('1994', NULL, '0', NULL, 'Watershed', NULL, NULL, NULL, 'http://bigwww.epfl.ch/sage/soft/watershed/', NULL),
('2000', NULL, '0', NULL, 'Volume Viewer', NULL, NULL, NULL, 'http://fiji.sc/Volume_Viewer', NULL),
('2037', NULL, '0', NULL, 'Webcam Capture (Xuggler)', NULL, NULL, NULL, 'http://icy.bioimageanalysis.org/plugin/Webcam Capture (Xuggler)', NULL),
('2073', NULL, '0', NULL, 'VIB Protocol', NULL, NULL, NULL, 'http://fiji.sc/VIB_Protocol', NULL),
('2074', NULL, '0', NULL, 'Volume Calculator', NULL, NULL, NULL, 'http://fiji.sc/Volume_Calculator', NULL),
('2128', NULL, '0', NULL, 'Aquarium', NULL, NULL, NULL, 'http://cbia.fi.muni.cz/projects/acquiarium.html', NULL),
('2132', NULL, '0', NULL, 'CellTracker', NULL, NULL, NULL, 'http://www2.warwick.ac.uk/fac/sci/systemsbiology/staff/bretschneider/celltracker/', NULL),
('2133', NULL, '0', NULL, 'Convolve with 2D Bessel function', NULL, NULL, NULL, 'http://mosaic.mpi-cbg.de/?q=downloads/imageJ', NULL),
('2134', NULL, '0', NULL, 'CytoPacq', NULL, NULL, NULL, 'http://cbia.fi.muni.cz/projects/simulator.html', NULL),
('2135', NULL, '0', NULL, 'DensitoQuant', NULL, NULL, NULL, 'http://www.3dhistech.com/DensitoQuant_module ', NULL),
('2136', NULL, '0', NULL, 'Difference of Gaussians ', NULL, NULL, NULL, 'http://tech.knime.org/community/image-processing', NULL),
('2138', NULL, '0', NULL, 'FLIMfit', NULL, NULL, NULL, 'https://www.openmicroscopy.org/site/products/partner/flimfit', NULL),
('2139', NULL, '0', NULL, 'FishQuant', NULL, NULL, NULL, 'http://www.3dhistech.com/fishquant_module ', NULL),
('2140', NULL, '0', NULL, 'HistoQuant', NULL, NULL, NULL, 'http://www.3dhistech.com/HistoQuant_module ', NULL),
('2142', NULL, '0', NULL, 'ImageJ/MosaicSuite', NULL, NULL, NULL, 'http://mosaic.mpi-cbg.de/?q=downloads/imageJ', NULL),
('2147', NULL, '0', NULL, 'ImarisFileReaders', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/imaris', NULL),
('2148', NULL, '0', NULL, 'ImarisImageProcessing', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/imaris', NULL),
('2149', NULL, '0', NULL, 'ImarisSectionView', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/imaris', NULL),
('2150', NULL, '0', NULL, 'ImarisSliceView', NULL, NULL, NULL, 'http://www.bitplane.com/imaris/imaris', NULL),
('2151', NULL, '0', NULL, 'Insert Poisson noise', NULL, NULL, NULL, 'http://mosaic.mpi-cbg.de/?q=downloads/imageJ', NULL),
('2152', NULL, '0', NULL, 'Interaction Analysis', NULL, NULL, NULL, 'http://mosaic.mpi-cbg.de/?q=downloads/imageJ', NULL),
('2154', NULL, '0', NULL, 'MATLAB/ Qu', NULL, NULL, NULL, 'http://www.scs2.net/next/index.php?id=120', NULL),
('2155', NULL, '0', NULL, 'Mahotas / Convolution', NULL, NULL, NULL, 'http://mahotas.readthedocs.org/', NULL),
('2156', NULL, '0', NULL, 'Mahotas / Distance Transform', NULL, NULL, NULL, 'http://mahotas.readthedocs.org/en/latest/distance.html', NULL),
('2157', NULL, '0', NULL, 'Mahotas / Feature Computation', NULL, NULL, NULL, 'http://mahotas.readthedocs.org/en/latest/features.html', NULL),
('2158', NULL, '0', NULL, 'Mahotas / Imread', NULL, NULL, NULL, 'https://github.com/luispedro/imread', NULL),
('2159', NULL, '0', NULL, 'Mahotas / Labeled image manipulation ', NULL, NULL, NULL, 'http://mahotas.readthedocs.org/en/latest/labeled.html', NULL),
('2160', NULL, '0', NULL, 'Mahotas / Morphological Operators', NULL, NULL, NULL, 'http://mahotas.readthedocs.org/en/latest/morphology.html', NULL),
('2161', NULL, '0', NULL, 'Mahotas / Multidimensional interpolation', NULL, NULL, NULL, 'http://mahotas.readthedocs.org/', NULL),
('2162', NULL, '0', NULL, 'Mahotas / SURF', NULL, NULL, NULL, 'http://mahotas.readthedocs.org/en/latest/surf.html', NULL),
('2163', NULL, '0', NULL, 'Mahotas / Thresholding', NULL, NULL, NULL, 'http://mahotas.readthedocs.org/en/latest/thresholding.html', NULL),
...
--
-- Structure de la table `keywordpaperrelation`
--
...
INSERT INTO `keywordpaperrelation` (`id_keyword`, `id_paper`) VALUES
('1', '2777'),
('1', '2792'),
('1', '2796'),
('4', '2760'),
...
('1358', 'parabola fit'),
('276', 'parallel'),
('756', 'parallel 2d binary skeleton'),
('2565', 'parallel beam projection'),
('1645', 'parallel computing'),
('999', 'parallel directional constrained collapse'),
('1401', 'parallelization'),
('2112', 'parents'),
('351', 'parser'),
('179', 'parsing mathematical equation'),
('1984', 'partial differential equation'),
('533', 'particle'),
('1741', 'particle analysis'),
('1987', 'particle detection'),
('2043', 'particle image velocimetry'),
('1218', 'particle tracking'),
('144', 'particles'),
('1140', 'parts'),
('1529', 'path'),
('2343', 'pathology'),
...
('591', 'percentile'),
('1132', 'perreault'),
('1219', 'persistent movement'),
('1968', 'perspective'),
('1692', 'perspective transform'),
('1693', 'perspective transformation'),
('2098', 'perturb'),
('1764', 'pet'),
('2080', 'pgm'),
...
('1975', 'plots'),
('1260', 'plotting'),
('394', 'plotting function'),
('473', 'pluggable'),
('95', 'plugin'),
('1499', 'plugin concept'),
('1034', 'plugin distribution'),
('1324', 'plugin list'),
('2222', 'plugin-extensions'),
('306', 'plugins'),
('2247', 'plugins (matlab'),
('2293', 'plugins matlab'),
('2294', 'plugins python'),
('234', 'point'),
('2571', 'point clouds'),
('960', 'point correspondence'),
('2496', 'point distribution model'),
('652', 'point spread function'),
('1024', 'point tool'),
('1065', 'poisson'),
('1066', 'poisson noise'),
('2175', 'polarized'),
...
('0', '', NULL),
('159', 'aaron', 'http://www.scs2.net'),
('552', 'abria', 'http://www.vaa3d.org'),
